...
public class ExerciseResultRecordTransform implements RecordTransform<ExerciseResultRecord, ExerciseResult> {
    ...
    public ExerciseResultRecord untransform(ExerciseResult model) {
        ...
        ExerciseResultRecord entity = new ExerciseResultRecord(pk, sk,
